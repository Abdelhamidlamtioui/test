...
SRC =  map_validation.c     libft/ft_memset.c      libft/ft_strjoin.c    printf/ft_print_pointer.c\
       ...
       renderer.c   libft/ft_split.c       printf/ft_printf.c         libft/ft_calloc.c\
       ft_start.c      libft/ft_strcmp.c      utils.c   libft/ft_bzero.c\
       libft/ft_strdup.c 
...
MLXFLAGS = -L/usr/include/minilibx-linux -lmlx -lXext -lX11
